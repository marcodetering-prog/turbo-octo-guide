          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
                <div className="text-sm text-purple-700 font-semibold uppercase">
                  Avg Response Time
                </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 border border-orange-200">
                <div className="text-sm text-orange-700 font-semibold uppercase">
                  Avg Resolution Time
                </div>
                <div className="text-3xl font-bold text-orange-900 mt-2">
                  {analytics.avgResolutionTime || 'N/A'} min
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-4 border border-red-200">
                ...
                <div className="text-3xl font-bold text-red-900 mt-2">
                  {analytics.dataQualityScore || 'N/A'}
                </div>
              </div>

              {/* Avg Conversation Length */}
              <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg p-4 border border-cyan-200">
                <div className="text-sm text-cyan-700 font-semibold uppercase">
                  Avg Conv. Length
                </div>
                <div className="text-3xl font-bold text-cyan-900 mt-2">
                  {parseFloat(analytics.avgConversationLength || 0).toFixed(1)} msgs
                </div>
              </div>
                  ...
                  <PieChart>
                    ...
                    >
                      {analytics.deficiencyData.map((entry, index) => (
                        <Cell
                          key={`cell-${index}`}
                          fill={COLORS.deficiencies[index % COLORS.deficiencies.length]}
                        />
                      ))}
                    </Pie>
                    <Tooltip />
                ...
                {analytics.costData.map((item, idx) => (
                  <div key={idx} className="bg-gray-50 p-3 rounded border border-gray-200">
                    ...
                    <div className="text-lg font-bold text-gray-800 mt-1">
                      ${parseFloat(item.avgCost).toFixed(2)}
                    </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow">
                ...
                <div className="text-2xl font-bold text-gray-800 mt-2">
                  {analytics.insideWorkingHours || 0}
                </div>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow">
                ...
                <div className="text-2xl font-bold text-gray-800 mt-2">
                  {analytics.outsideWorkingHours || 0}
                </div>
                <div className="text-xs text-gray-500 mt-1">inquiries</div>
              </div>
